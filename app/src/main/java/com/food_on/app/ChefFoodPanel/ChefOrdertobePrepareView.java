                                                                        ...
                                                                        public void onSuccess(Void aVoid) {
                                                                            ...
                                                                            FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                ...
                                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                    ...
                                                                                    sendNotifications(usertoken, "Εκτιμόμενος χρόνος", "Ετοιμάζουμε την παραγγελία σας", "Preparing");
                                                                                    progressDialog.dismiss();
                                                                                    AlertDialog.Builder builder = new AlertDialog.Builder(ChefOrdertobePrepareView.this);
                                                                                    builder.setMessage("Δες τις παραγγελίες που ετοιμάζονται");
            ...
            public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                if (response.code() == 200) {
                    if (response.body().success != 1) {
                        Toast.makeText(ChefOrdertobePrepareView.this, "Απέτυχε", Toast.LENGTH_SHORT).show();
                    }
                }
