...
public class ChefPendingOrdersAdapter extends RecyclerView.Adapter<ChefPendingOrdersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.grandtotalprice.setText("Σύνολο: € " + chefPendingOrders1.getGrandTotalPrice());
                                                                                            ...
                                                                                            public void onSuccess(Void aVoid) {
                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        sendNotifications(usertoken, "Η παραγγελία έγινε δεκτή", "Η παραγγελία έγινε δεκτή, προχωρήστε στην πληρωμή", "Payment");
                                                                                                        ReusableCodeForAll.ShowAlert(context,"","Περιμένετε μέχρι ο πελάτης να κάνει την πληρωμή");
                ...
                Reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                String usertoken = dataSnapshot.getValue(String.class);
                                sendNotifications(usertoken, "Η παραγγελία δεν έγινε δεκτή", "Η παραγγελία δεν έγινε δεκτή λόγο τεχνικών δυσκολιών", "Home");
                                FirebaseDatabase.getInstance().getReference("CustomerPendingOrders").child(userid).child(random).child("Dishes").removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    @Override
                                    public void onComplete(@NonNull Task<Void> task) {
