...
public class Chef_PostDish extends AppCompatActivity {
        ...
        if (imageuri != null) {
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(City).child(Sub).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Chef_PostDish.this, "Το πίατο δημοσιεύθηκε!", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    progressDialog.setMessage("Ανέβηκε το " + (int) progress + "%");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Έγινε το crop", Toast.LENGTH_SHORT).show();
            } else if (resultCode == CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE) {
                Toast.makeText(this, "To Crop απέτυχε" + result.getError(), Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (mCropimageuri != null && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(this, "ακυρώθηκε, απαιτούνται δικαιώματα", Toast.LENGTH_SHORT).show();
        }
    }
