...
public class Update_Delete_Dish extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Delete_dish.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setMessage("Θές να διαγράψεις το πιάτο?");
                        builder.setPositiveButton("Ναι", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                food.setMessage("Το πίατο διαγράφηκε");
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Dishname.setText("Όνομα πίατου: " + updateDishModel.getDishes());
    ...
    private boolean isValid() {
        ...
        if (TextUtils.isEmpty(description)) {
            ...
            desc.setError("Η περιγραφή είναι υποχρεωτική");
        ...
        if (TextUtils.isEmpty(quantity)) {
            ...
            qty.setError("Η ποσότητα είναι υποχρεωτική");
        } else {
            isvalidQuantity = true;
        }
        if (TextUtils.isEmpty(price)) {
            pri.setErrorEnabled(true);
            pri.setError("Η τιμή είναι υποχρεωτική");
        } else {
            isValidPrice = true;
        }
    ...
    private void uploadImage() {
        ...
        if (imageuri != null) {
            ...
            progressDialog.setTitle("Ανεβαίνει...");
            progressDialog.show();
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(Update_Delete_Dish.this, "Αποτυχία : " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    progressDialog.setMessage("Ανέβηκε " + (int) progress + "%");
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(State).child(City).child(Sub)
            ...
            public void onComplete(@NonNull Task<Void> task) {
                progressDialog.dismiss();
                Toast.makeText(Update_Delete_Dish.this, "Ενημερώθηκε με επιτυχία", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "Έγινε Crop" + result.getSampleSize(), Toast.LENGTH_SHORT).show();
            } else if (resultCode == CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE) {
                Toast.makeText(this, "Αποτυχία Crop" + result.getError(), Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (mCropimageuri != null && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(this, "ακυρώθηκε, μή επαρκή δηκαιώματα", Toast.LENGTH_SHORT).show();
        }
    }
