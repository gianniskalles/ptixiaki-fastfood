                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (FAuth.getCurrentUser().isEmailVerified()) {
                                        mDialog.dismiss();
                                        Toast.makeText(ChefLogin.this, "Είσαι συνδεδεμένος", Toast.LENGTH_SHORT).show();
                                        ...
                                        ReusableCodeForAll.ShowAlert(ChefLogin.this, "", "Παρακαλω επιβεβαίωσε το Email σου");
                                    }

                                } else {

                                    mDialog.dismiss();
                                    ReusableCodeForAll.ShowAlert(ChefLogin.this, "Λάθος", task.getException().getMessage());
                                }
                            }
                        });
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(em)) {
            ...
            if (em.matches(emailpattern)) {
                ...
                email.setErrorEnabled(true);
                email.setError("Βάλε ένα έγγυρο Email");
            }
