...
public class ChefRegisteration extends AppCompatActivity {
    ...
    String[] Ήπειρος = {"Θεσπρωτίας", "Ιωαννίνων"};
    String[] Στεραιά_Ελλάδα = {"Φωκίδας",};


    String[] Θεσπρωτίας = {"Ηγουμενίτσα", "Φιλίατες", "Παραμυθιά"};


    String[] Ιωαννίνων = {"Ιωάννινα", "Πράμαντα",};
    String[] Φωκίδας = {"Δεσφίνα"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Ήπειρος")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : Ήπειρος) {
                        list.add(text);
                    }
                ...
                if (statee.equals("Στεραιά Ελλάδα")) {
                    ArrayList<String> list = new ArrayList<>();
                    for (String text : Στεραιά_Ελλάδα) {
                        list.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegisteration.this, android.R.layout.simple_spinner_item, list);
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("Θεσπρωτίας")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Θεσπρωτίας) {
                        listt.add(text);
                    }
                ...
                if (cityy.equals("Ιωαννίνων")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Ιωαννίνων) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegisteration.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
                ...
                if (cityy.equals("Φωκίδας")) {
                    ArrayList<String> listt = new ArrayList<>();
                    for (String text : Φωκίδας) {
                        listt.add(text);
                    }
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(ChefRegisteration.this, android.R.layout.simple_spinner_item, listt);
                    Suburban.setAdapter(arrayAdapter);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    ...
                    mDialog.setMessage("Γίνεται εγγραφή, περιμένετε...");
                    mDialog.show();
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            builder.setMessage("Η εγγραφή έγινε με επιτυχία, επιβεβαίωσε το Email σου");
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(ChefRegisteration.this, "Λάθος", task.getException().getMessage());
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(fname)) {
            ...
            Fname.setError("Το όνομα είναι υποχρεωτικό");
        } else {
            isValidname = true;
        }
        if (TextUtils.isEmpty(lname)) {
            Lname.setErrorEnabled(true);
            Lname.setError("Το επώνυμο είναι υποχρεωτικό");
        } else {
            isvalidlname = true;
        }
        if (TextUtils.isEmpty(emailid)) {
            ...
            if (emailid.matches(emailpattern)) {
                ...
                Email.setErrorEnabled(true);
                Email.setError("Βάλε ένα έγκυρο Email");
            }

        }
        if (TextUtils.isEmpty(password)) {
            Pass.setErrorEnabled(true);
            Pass.setError("Ο κωδικός έιναι υποχρεωτικός");
        } else {
            if (password.length() < 6) {
                Pass.setErrorEnabled(true);
                Pass.setError("αδύναμος κωδικός");
            } else {
        ...
        if (TextUtils.isEmpty(confirmpassword)) {
            ...
            cfpass.setError("Η επιβεβαίωση κωδικού είναι υποχρεωτική");
        } else {
            if (!password.equals(confirmpassword)) {
                Pass.setErrorEnabled(true);
                Pass.setError("Οι κωδικοί δεν ταιρίαζουν");
            } else {
        ...
        if (TextUtils.isEmpty(mobile)) {
            ...
            mobileno.setError("Το τηλέφωνο είναι υποχρεωτικό");
        } else {
            if (mobile.length() < 10) {
                mobileno.setErrorEnabled(true);
                mobileno.setError("Λάθος τηλέφωνο");
            } else {
        ...
        if (TextUtils.isEmpty(house)) {
            ...
            houseno.setError("Το πεδίο δεν μπορεί να είναι άδειο");
        } else {
            isvalidhousestreetno = true;
        }
        if (TextUtils.isEmpty(Area)) {
            area.setErrorEnabled(true);
            area.setError("Το πεδίο δεν μπορεί να είναι άδειο");
        } else {
            isvalidarea = true;
        }
        if (TextUtils.isEmpty(Postcode)) {
            postcode.setErrorEnabled(true);
            postcode.setError("Το πεδίο δεν μπορεί να είναι άδειο");
        } else {
