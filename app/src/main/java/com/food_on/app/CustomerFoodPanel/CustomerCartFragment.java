                ...
                if (cartModelList.size() == 0) {
                    ...
                    remove.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setMessage("Είσαι σίγουρος?");
                                    ...
                                    FirebaseDatabase.getInstance().getReference("AlreadyOrdered").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("isOrdered").addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            if (ss.trim().equalsIgnoreCase("false") || ss.trim().equalsIgnoreCase("")) {
                                                ...
                                                AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
                                                builder.setTitle("Βάλε διεύθηνση");
                                                ...
                                                builder.setPositiveButton("Ναι", new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        progressDialog.setMessage("Παρακαλώ περιμένεται...");
                                                        progressDialog.show();
                                                                                                                            ...
                                                                                                                            public void onSuccess(Void aVoid) {
                                                                                                                                ...
                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(ChefId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                    ...
                                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                        ...
                                                                                                                                        sendNotifications(usertoken, "Νέα παραγγελία", "Έχεις νέα παραγγελία", "Order");
                                                                                                                                        progressDialog.dismiss();
                                                                                                                                        ReusableCodeForAll.ShowAlert(getContext(), "", "Η παραγγελία σου μπήκε σε αναμονή, περίμενε μέχρι να γίνει αποδοχή.");
                                                                                                                                    }
...
//                                                                }
                                                ...
                                                ReusableCodeForAll.ShowAlert(getContext(), "Error", "Η παραγγελία έχει ήδη τοποθετηθεί, δεν μπορείς να βάλεις άλλη μεχρι να ολοκληρωθεί αυτή");
                                            }
            ...
            public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                if (response.code() == 200) {
                    if (response.body().success != 1) {
                        Toast.makeText(getContext(), "Αποτυχία", Toast.LENGTH_SHORT).show();
                    }
                }
