                                                                                            ...
                                                                                            public void onSuccess(Void aVoid) {
                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(ChefID).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        sendNotifications(usertoken, "Η παραγγελία επιβεβαιώθηκε", "Η πληρωμή επιβεβαιώθηκε, Μπορείς να συνεχίσεις την παραγγελία", "Confirm");
                                                                                                    }
            ...
            public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                if (response.code() == 200) {
                    if (response.body().success != 1) {
                        Toast.makeText(CustomerPayment.this, "Αποτυχία", Toast.LENGTH_SHORT).show();
                    }
                }
            }
