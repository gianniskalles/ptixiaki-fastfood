            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String qua = "<b>" + "Ποσότητα: " + "</b>" + updateDishModel.getQuantity();
                        FoodQuantity.setText(Html.fromHtml(qua));
                        String ss = "<b>" + "Περιγραφή: " + "</b>" + updateDishModel.getDescription();
                        FoodDescription.setText(Html.fromHtml(ss));
                        String pri = "<b>" + "Τιμή €: " + "</b>" + updateDishModel.getPrice();
                        ...
                        chefdata.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                String name = "<b>" + "Όνομα καταστήματος/chef: " + "</b>" + chef.getFname() + " " + chef.getLname();
                                ChefName.setText(Html.fromHtml(name));
                                String loc = "<b>" + "Τοποθεσία: " + "</b>" + chef.getSuburban();
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                                ...
                                                if (num != 0) {
                                                    ...
                                                    reference.setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            ...
                                                            Toast.makeText(OrderDish.this, "Προστέθηκε στο καλάθι", Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                    ...
                                    else
                                    {
                                        ...
                                        builder.setMessage("Μπορείς να βάλεις περισσότερα απο ένα φαγητά του ίδιου καταστήματος/Σεφ.");
