...
public class Delivery_Login extends AppCompatActivity {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (FAuth.getCurrentUser().isEmailVerified()) {
                                    mDialog.dismiss();
                                    Toast.makeText(Delivery_Login.this, "Είσαι συνδεδεμένος", Toast.LENGTH_SHORT).show();
                                    ...
                                    ReusableCodeForAll.ShowAlert(Delivery_Login.this, "", "Επιβεβαίωσε το Email σου");
                                }

                            } else {

                                mDialog.dismiss();
                                ReusableCodeForAll.ShowAlert(Delivery_Login.this, "Λάθος", task.getException().getMessage());
                            }
                        }
                    });
                }
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(pwd)) {
            ...
            pass.setError("Ο κωδικός είναι υποχρεωτικός");
        } else {
