...
public class Registeration extends AppCompatActivity {
    ...
    public boolean isValid() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            emaill.setError("Το Email είναι υποχρεωτικό");
        } else {
            if (email.matches(emailpattern)) {
                isValidemail = true;
            } else {
                emaill.setErrorEnabled(true);
                emaill.setError("Βάλε ένα σωστό Email");
            }

        }
        if (TextUtils.isEmpty(mobileno)) {
            Mobileno.setErrorEnabled(true);
            Mobileno.setError("Το κινητό είναι υποχρεωτικό");
        } else {
            if (mobileno.length() < 10) {
                Mobileno.setErrorEnabled(true);
                Mobileno.setError("Λάθος κινητό");
            } else {
        ...
        if (TextUtils.isEmpty(password)) {
            ...
            pass.setError("Ο κωδικός είναι υποχρεωτικό");
        } else {
            if (password.length() < 6) {
                pass.setErrorEnabled(true);
                pass.setError("Αδύναμος κωδικός");
                cmpass.setError("Αδύναμος κωδικός");
            } else {
        ...
        if (TextUtils.isEmpty(confirmpass)) {
            ...
            cmpass.setError("Η επιβεβαίωση κωδικού είναι υποχρεωτική");
        } else {
            if (!password.equals(confirmpass)) {
                pass.setErrorEnabled(true);
                pass.setError("Οι κωδικοί δεν ταιριάζουν");
                cmpass.setError("Οι κωδικοί δεν ταιριάζουν");
            } else {
        ...
        if (TextUtils.isEmpty(Localaddress)) {
            ...
            localadd.setError("Η διεύθηνση είναι υποχρεωτική");
        } else {
            isValidaddress = true;
        }
