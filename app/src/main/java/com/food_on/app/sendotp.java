    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.isEmpty() && code.length() < 6) {
                    entercode.setError("Βάλε κωδικό");
        ...
        new CountDownTimer(60000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                txt.setText("Επαναποστολή κωδικού σε " + millisUntilFinished / 1000 + " δευτερόλεπτα");
            }
        ...
        Resend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(60000, 1000) {
                    ...
                    public void onTick(long millisUntilFinished) {
                        txt.setVisibility(View.VISIBLE);
                        txt.setText("Επαναποστολή κωδικού σε  " + millisUntilFinished / 1000 + " δευτερόλετα");
                    }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                ReusableCodeForAll.ShowAlert(sendotp.this,"Λάθος",task.getException().getMessage());
                            }
                        }
                    });
        } catch (Exception e) {
